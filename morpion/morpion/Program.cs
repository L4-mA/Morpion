...
namespace Morpion
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            AfficherMorpion(10, 10);						 //--- initialisation de la grille ---
            Console.WriteLine(" ");
	        ...
	        for (j=0; j < grille.GetLength(0); j++)
		        for (k=0; k < grille.GetLength(1); k++)
					...
					while(!gagner && essais != 9)
					{
						...
						try
						{
							Console.WriteLine("Matrix : " + j.ToString() + " . " + k.ToString() + " valeur : " + grille[j, k]);
							Console.WriteLine("Ligne   =    " +grille.GetLength(0));
							Console.WriteLine("Colonne =    "+grille.GetLength(1));
